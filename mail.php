...
if ($name == "") {
    ...
    $headers .= 'From:  PSR Web Design <escaparateura@gmail.com>' . "\r\n";
    $headers .= 'cc: info@psrwebdesign.com' . "\r\n";
    $headers .= 'bcc: info@psrwebdesign.com' . "\r\n";
    mail($to, $subject, $_message, $headers, '-f escaparateura@gmail.com');
